...
class Main {
    ...
    public static run() {
        ...
        PIXI.loader.add('bunny', './res/activities_arrow.png').load(function(loader, resources) {
            ...
            var bunny1 = new PIXI.Sprite(resources.bunny.texture);
            ...
            var bunny3 = new PIXI.Sprite(resources.bunny.texture);
            ...
            var bunny4 = new PIXI.Sprite(resources.bunny.texture);
            bunny4.x = 0;
